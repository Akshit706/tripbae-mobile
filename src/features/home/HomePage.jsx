  ...
  return (
    <div style={{ margin: '-1rem -0.95rem', fontFamily: "'Inter', 'DM Sans', sans-serif", minHeight: '100svh', display: 'flex', flexDirection: 'column' }}>
      <style>{`
        ...
        @keyframes lumiExit { 0%{transform:translateY(-100%);opacity:1} 30%{transform:translateY(-124%);opacity:1} 100%{transform:translateY(0);opacity:0} }
          ...
          <div key={trip.id} style={{ position: 'relative' }}>
            <img
              ...
              style={{
                ...
                animation: 'lumiRise 0.42s ease-out both 0.45s, lumiExit 0.58s ease-in both 6s',
              }}
            />
            <TripCard
              trip={trip}
