export const S = {
  ...
  tripPill: { marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 5, background: 'linear-gradient(130deg,#E7FFF6,#E8F9F1)', border: '1px solid rgba(42,168,124,0.3)', borderRadius: 999, padding: '6px 13px', fontSize: 12, color: '#7A2E00', fontWeight: 600, cursor: 'pointer', boxShadow: '0 8px 20px rgba(23,127,94,0.12)' },
