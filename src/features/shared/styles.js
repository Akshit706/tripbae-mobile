export const S = {
  ...
  tripPill: { marginLeft: 'auto', display: 'flex', alignItems: 'center', gap: 5, background: 'linear-gradient(130deg,#0F6E56,#0F6E56)', border: '1px solid rgba(15,110,86,0.3)', borderRadius: 999, padding: '6px 13px', fontSize: 12, color: '#0F6E56', fontWeight: 600, cursor: 'pointer', boxShadow: '0 8px 20px rgba(15,110,86,0.12)' },
