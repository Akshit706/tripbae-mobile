export const S = {
  ...
  navTabs: { background: '#fff', borderBottom: 'none', display: 'grid', padding: '4px 0 6px', gap: 0 },
  navTab: { display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 2, padding: '5px 2px', fontSize: 9, fontWeight: 500, color: '#9AA3B0', cursor: 'pointer', background: 'transparent', border: 'none', borderRadius: 10, fontFamily: "'DM Sans',sans-serif", whiteSpace: 'normal', wordBreak: 'break-word', textAlign: 'center', lineHeight: 1.15, minWidth: 0, overflow: 'hidden', transition: 'color 140ms' },
  navTabActive: { color: '#0F6E56', fontWeight: 700 },
  soloNavTabActive: { color: '#534AB7', fontWeight: 700 },
